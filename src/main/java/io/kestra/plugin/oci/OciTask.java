    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.oci.OciTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class OciTask extends Task implements RunnableTask<OciTask.Output> {
    @Schema(
    ...
    @Override
    public OciTask.Output run(RunContext runContext) throws Exception {
